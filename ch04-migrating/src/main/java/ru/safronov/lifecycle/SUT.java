...
public class SUT {
  ...
  public SUT(String systemName) {
    ...
    System.out.println(
        systemName + " from class " + getClass().getSimpleName() + " is initializing");
  }

  public boolean canReceiveRegularWork() {
    System.out.println(
        systemName + " from class " + getClass().getSimpleName() + " can receive regular work");
    return true;
  }

  public boolean canReceiveAdditionalWork() {
    System.out.println(
        systemName + " from class " + getClass().getSimpleName() + " can't receive additional work");
    return false;
  }
